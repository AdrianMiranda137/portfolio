    ...
    public partial class usersignup1 : System.Web.UI.Page
    {
        ...
        void signUpNewMember()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO Empleado(Nombre,FechaNac,Telefono,Email,NSS,Fotografia,Direccion,Usuario,Contrasena,Estado) values(@Nombre,@FechaNac,@Telefono,@Email,@NSS,@Fotografia,@Direccion,@Usuario,@Contrasena,@Estado)", con);
                ...
                cmd.Parameters.AddWithValue("@Contrasena", TextBox10.Text.Trim());
                cmd.ExecuteNonQuery();
                con.Close();
